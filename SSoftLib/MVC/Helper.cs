...
namespace SSoft.MVC
{
    public class Helper
    {
        public static string GetHttpDownloadFileURL(string guid)
        {
            ...
            {
                returnURL = "http://" + System.Web.HttpContext.Current.Request.Url.Host;

                if (System.Web.HttpContext.Current.Request.Url.Port != 80)
                {
                    returnURL += ":" + System.Web.HttpContext.Current.Request.Url.Port;
                }
                if (System.Web.HttpContext.Current.Request.ApplicationPath != "/")
                {
                    returnURL += System.Web.HttpContext.Current.Request.ApplicationPath;
                }
                ...
                {
                    returnURL += "/api/PUBLIC/POSTDownloadFile?id=" + guid;
                }
            }
            else
            {
