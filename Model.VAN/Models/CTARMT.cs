...
{
    public partial class CTARMT
    {
        public CTARMT()
        {
            CTARACT = new HashSet<CTARACT>();
            CTARDL = new HashSet<CTARDL>();
            CTARPACT = new HashSet<CTARPACT>();
        }
        ...
        public string C_PRCV { get; set; }
        public string C_AJS_PRCV { get; set; }
        ...
        public string C_AJS_AR { get; set; }
        public string AR_AVCH_TY { get; set; }
        public string AR_AVCH_NO { get; set; }
        public string AR_ACT_NO { get; set; }
        public string AR_BCH_NO { get; set; }
        public string AR_REMK { get; set; }
        ...
        public virtual ICollection<CTARACT> CTARACT { get; set; }
        public virtual ICollection<CTARDL> CTARDL { get; set; }
        public virtual ICollection<CTARPACT> CTARPACT { get; set; }
    }
}
